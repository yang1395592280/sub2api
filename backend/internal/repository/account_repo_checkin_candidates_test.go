...
func TestListSub2APICheckinCandidates(t *testing.T) {
	...
	require.Contains(t, normalized, "platform IN ('openai', 'anthropic', 'gemini', 'kimi', 'deepseek', 'zhipu', 'grok')")
...
func TestListUpstreamBalanceRefreshCandidatesByGroupID(t *testing.T) {
	...
	require.Contains(t, normalized, "a.platform IN ('openai', 'anthropic', 'gemini', 'kimi', 'deepseek', 'zhipu', 'grok')")
