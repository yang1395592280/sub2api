...
const openAISchedulerObservabilityIndexMigration = "182_openai_scheduler_observability_index_notx.sql"
const openAISchedulerObservabilityIndex = "idx_usage_logs_e2e_ttft_created_at"
...
var migrationChecksumCompatibilityRules = map[string]migrationChecksumCompatibilityRule{
	...
	"117_openai_auto_scheduler.sql":                           newMigrationChecksumCompatibilityRule("9517704cd947dfe819f0223768cbdc58074a4943024272a944e4e040e13e003f", "9ba0550bc15d28d0e4b38457375b27473e0275217de1a8e6bd1e7f237a188afc"),
...
func prepareNonTransactionalMigration(ctx context.Context, db migrationConnection, name string) error {
	...
	case openAISchedulerObservabilityIndexMigration:
		return dropInvalidIndexIfPresent(ctx, db, openAISchedulerObservabilityIndex)
