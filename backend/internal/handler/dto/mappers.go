...
func APIKeyFromService(k *service.APIKey) *APIKey {
	...
	out := &APIKey{
		...
		Name:                             k.Name,
		GroupID:                          k.GroupID,
		GroupSelectMode:                  k.NormalizedGroupSelectMode(),
		Status:                           k.Status,
		IPWhitelist:                      k.IPWhitelist,
		IPBlacklist:                      k.IPBlacklist,
		LastUsedAt:                       k.LastUsedAt,
		LastUsedIP:                       k.LastUsedIP,
		LastEffectiveGroupID:             k.LastEffectiveGroupID,
		LastEffectiveGroupAt:             k.LastEffectiveGroupAt,
		OpenAIAutoGroupMaxRateMultiplier: k.OpenAIAutoGroupMaxRateMultiplier,
		Quota:                            k.Quota,
		...
		LastEffectiveGroup:               GroupFromServiceShallow(k.LastEffectiveGroup),
	}
...
func AccountFromServiceShallow(a *service.Account) *Account {
	...
	out := &Account{
		...
		ChannelPrice:            a.ChannelPrice,
		UpstreamRechargeRatio:   a.EffectiveUpstreamRechargeRatio(),
		Status:                  a.Status,
		ErrorMessage:            a.ErrorMessage,
		LastUsedAt:              a.LastUsedAt,
		ExpiresAt:               timeToUnixSeconds(a.ExpiresAt),
		AutoPauseOnExpired:      a.AutoPauseOnExpired,
		AutoGroupingEnabled:     a.IsAutoGroupingEnabled(),
...
func usageLogFromServiceUser(l *service.UsageLog) UsageLog {
	...
	return UsageLog{
		...
		APIKeyGroupSelectMode:     l.APIKeyGroupSelectMode,
		...
		E2EFirstTokenMs:           l.E2EFirstTokenMs,
		BodyReadMs:                l.BodyReadMs,
		PreprocessMs:              l.PreprocessMs,
		UserQueueMs:               l.UserQueueMs,
		RoutingMs:                 l.RoutingMs,
		QueueMs:                   l.QueueMs,
		RetryMs:                   l.RetryMs,
