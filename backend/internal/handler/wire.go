...
func ProvideAdminUserHandler(adminService service.AdminService, concurrencyService *service.ConcurrencyService, userPlatformQuotaRepo service.UserPlatformQuotaRepository, billingCache service.BillingCache, totpService *service.TotpService, userService *service.UserService, settingService *service.SettingService, apiKeyRepo service.APIKeyRepository) *admin.UserHandler {
	...
	h.SetAPIKeyRepository(apiKeyRepo)
	return h
}
