...
type GenerateRedeemCodesRequest struct {
	...
	Type          string     `json:"type" binding:"required,oneof=balance concurrency subscription invitation lottery_ticket"`
...
type CreateAndRedeemCodeRequest struct {
	...
	Type          string     `json:"type" binding:"omitempty,oneof=balance concurrency subscription invitation lottery_ticket"` // 不传时默认 balance（向后兼容）
