...
func registerGroupRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	groups := admin.Group("/groups")
	{
		...
		groups.GET("/:id/capacity-users", h.Admin.Group.GetCapacityUsers)
		...
		groups.GET("/:id/members", h.Admin.Group.GetGroupMembers)
		groups.DELETE("/:id/members/:user_id", h.Admin.Group.RemoveGroupMember)
...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.POST("/:id/upstream-checkin/test", h.Admin.Account.TestUpstreamCheckin)
...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		adminSettings.GET("/openai-overbrush", h.Admin.Setting.GetOpenAIOverbrushSettings)
		adminSettings.PUT("/openai-overbrush", h.Admin.Setting.UpdateOpenAIOverbrushSettings)
...
func registerAffiliateRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	affiliates := admin.Group("/affiliates")
	{
		...
		affiliates.GET("/ticket-campaign/events", h.Admin.Affiliate.ListTicketCampaignEvents)
