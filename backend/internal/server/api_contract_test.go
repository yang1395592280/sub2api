...
func TestAPIContracts(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			path:   "/api/v1/keys",
			body:   `{"name":"Key One","custom_key":"sk_custom_1234567890","group_select_mode":"openai_auto_cheapest"}`,
			headers: map[string]string{
				...
				"data": [
					{
						...
						"allow_auto_cheapest_scheduling": false,
						"upstream_balance_refresh_enabled": false,
						"upstream_balance_refresh_interval_seconds": 0,
...
func (r *stubUsageLogRepo) GetUserSpendingRanking(ctx context.Context, startTime, endTime time.Time, page, pageSize int, sortBy, sortOrder string) (*usagestats.UserSpendingRankingResponse, error) {
	return nil, errors.New("not implemented")
}
