...
func TestGetModelPricing_OpenAIGPT55Fallback(t *testing.T) {
	svc := newTestBillingService()
...
func TestIsOpenAIGPT54Model_IncludesGpt55(t *testing.T) {
	require.True(t, isOpenAIGPT54Model("gpt-5.4"))
	require.True(t, isOpenAIGPT54Model("gpt-5.5"))
	require.False(t, isOpenAIGPT54Model("claude-sonnet-4-5"))
}
