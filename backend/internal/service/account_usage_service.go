...
type UsageLogRepository interface {
	...
	GetUserSpendingRanking(ctx context.Context, startTime, endTime time.Time, page, pageSize int, sortBy, sortOrder string) (*usagestats.UserSpendingRankingResponse, error)
