...
func (s *SettingService) InitializeDefaultSettings(ctx context.Context) error {
	...
	defaults := map[string]string{
		...
		SettingKeyRedeemCodePurchaseEnabled:                 "false",
		SettingKeyRedeemCodePurchaseName:                    "兑换码购买",
		...
		SettingKeyAffiliateTicketCampaignEnabled: "true",
...
func (s *SettingService) parseSettings(settings map[string]string) *SystemSettings {
	...
	result := &SystemSettings{
		...
		RedeemCodePurchaseEnabled:              settings[SettingKeyRedeemCodePurchaseEnabled] == "true",
		RedeemCodePurchaseName:                 s.getStringOrDefault(settings, SettingKeyRedeemCodePurchaseName, "兑换码购买"),
	...
	result.AffiliateTicketCampaignEnabled = !isFalseSettingValue(settings[SettingKeyAffiliateTicketCampaignEnabled])
