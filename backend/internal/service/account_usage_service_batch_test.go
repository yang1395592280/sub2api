...
func (r *usageBatchLogRepoStub) GetGroupUserDailyStatsBatch(context.Context, int64, []int64, time.Time, time.Time) (map[int64]*usagestats.AccountStats, error) {
	return nil, nil
}
...
func (r *usageBatchLogRepoStub) GetUserSpendingRanking(context.Context, time.Time, time.Time, int, int, string, string) (*usagestats.UserSpendingRankingResponse, error) {
	return nil, nil
}
