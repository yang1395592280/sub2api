...
func cloneGroupForDuplicate(source *Group, operationID string) *Group {
	return &Group{
		...
		OpenAIAutoSchedulerEnabled:            source.OpenAIAutoSchedulerEnabled,
		AllowAutoCheapestScheduling:           source.AllowAutoCheapestScheduling,
		UpstreamBalanceRefreshEnabled:         source.UpstreamBalanceRefreshEnabled,
		UpstreamBalanceRefreshIntervalSeconds: source.UpstreamBalanceRefreshIntervalSeconds,
		UpstreamPriceMaxMultiplier:            source.UpstreamPriceMaxMultiplier,
		UpstreamPriceGroupingEnabled:          source.UpstreamPriceGroupingEnabled,
		UpstreamPriceGroupingMin:              source.UpstreamPriceGroupingMin,
		UpstreamPriceGroupingMax:              source.UpstreamPriceGroupingMax,
