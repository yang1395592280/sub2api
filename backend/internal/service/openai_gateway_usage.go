...
func (s *OpenAIGatewayService) RecordUsage(ctx context.Context, input *OpenAIRecordUsageInput) error {
	...
	multiplier = ResolveOpenAIDynamicBillingMultiplier(ctx, apiKey, account, s.settingService, multiplier)
	...
	usageLog.GroupNameSnapshot = usageLogGroupNameSnapshot(apiKey)
	usageLog.APIKeyGroupSelectMode = optionalTrimmedStringPtr(apiKey.NormalizedGroupSelectMode())
	if subscription != nil {
