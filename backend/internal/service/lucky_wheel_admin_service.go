...
const (
	...
	SettingKeyLuckyWheelDailySpinLimit = "lucky_wheel_daily_spin_limit"
	SettingKeyLuckyWheelPrizes         = "lucky_wheel_prizes"
	SettingKeyLuckyWheelRulesMarkdown  = "lucky_wheel_rules_markdown"
