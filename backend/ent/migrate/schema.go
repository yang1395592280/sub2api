...
var (
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "upstream_recharge_ratio", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(12,6)"}},
		{Name: "status", Type: field.TypeString, Size: 20, Default: "active"},
		{Name: "error_message", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "last_used_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "expires_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "auto_pause_on_expired", Type: field.TypeBool, Default: true},
		{Name: "auto_grouping_enabled", Type: field.TypeBool, Default: true},
	...
	AccountGroupsColumns = []*schema.Column{
		{Name: "priority", Type: field.TypeInt, Default: 50},
		{Name: "price_grouping_locked", Type: field.TypeBool, Default: false},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
