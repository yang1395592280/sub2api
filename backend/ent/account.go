...
type Account struct {
	...
	// ChannelPrice holds the value of the "channel_price" field.
	ChannelPrice *float64 `json:"channel_price,omitempty"`
	// UpstreamRechargeRatio holds the value of the "upstream_recharge_ratio" field.
	...
	AutoGroupingEnabled bool `json:"auto_grouping_enabled,omitempty"`
...
func (*Account) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case account.FieldCredentials, account.FieldExtra:
			values[i] = new([]byte)
		case account.FieldAutoPauseOnExpired, account.FieldAutoGroupingEnabled, account.FieldSchedulable:
			values[i] = new(sql.NullBool)
		case account.FieldRateMultiplier, account.FieldChannelPrice, account.FieldUpstreamRechargeRatio:
...
func (_m *Account) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case account.FieldChannelPrice:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field channel_price", values[i])
			} else if value.Valid {
				_m.ChannelPrice = new(float64)
				*_m.ChannelPrice = value.Float64
			}
		case account.FieldUpstreamRechargeRatio:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field upstream_recharge_ratio", values[i])
			} else if value.Valid {
				_m.UpstreamRechargeRatio = value.Float64
			}
		...
		case account.FieldAutoGroupingEnabled:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field auto_grouping_enabled", values[i])
			} else if value.Valid {
				_m.AutoGroupingEnabled = value.Bool
			}
...
func (_m *Account) String() string {
	...
	builder.WriteString(", ")
	if v := _m.ChannelPrice; v != nil {
		builder.WriteString("channel_price=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
	builder.WriteString("upstream_recharge_ratio=")
	builder.WriteString(fmt.Sprintf("%v", _m.UpstreamRechargeRatio))
	builder.WriteString(", ")
	...
	builder.WriteString(", ")
	builder.WriteString("auto_grouping_enabled=")
	builder.WriteString(fmt.Sprintf("%v", _m.AutoGroupingEnabled))
	builder.WriteString(", ")
