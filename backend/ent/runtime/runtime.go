...
func init() {
	...
	groupDescOpenaiAutoSchedulerEnabled := groupFields[53].Descriptor()
	...
	groupDescAllowAutoCheapestScheduling := groupFields[54].Descriptor()
	...
	groupDescUpstreamBalanceRefreshEnabled := groupFields[55].Descriptor()
	...
	groupDescUpstreamBalanceRefreshIntervalSeconds := groupFields[56].Descriptor()
	...
	groupDescUpstreamPriceMaxMultiplier := groupFields[57].Descriptor()
	...
	groupDescUpstreamPriceGroupingEnabled := groupFields[58].Descriptor()
	...
	groupDescUpstreamPriceGroupingMin := groupFields[59].Descriptor()
	...
	groupDescUpstreamPriceGroupingMax := groupFields[60].Descriptor()
	...
	// groupDescDynamicBillingEnabled is the schema descriptor for dynamic_billing_enabled field.
	groupDescDynamicBillingEnabled := groupFields[61].Descriptor()
	// group.DefaultDynamicBillingEnabled holds the default value on creation for the dynamic_billing_enabled field.
	group.DefaultDynamicBillingEnabled = groupDescDynamicBillingEnabled.Default.(bool)
