...
func init() {
	...
	// accountDescAutoGroupingEnabled is the schema descriptor for auto_grouping_enabled field.
	accountDescAutoGroupingEnabled := accountFields[19].Descriptor()
	// account.DefaultAutoGroupingEnabled holds the default value on creation for the auto_grouping_enabled field.
	account.DefaultAutoGroupingEnabled = accountDescAutoGroupingEnabled.Default.(bool)
	...
	// channelmonitorDescSortOrder is the schema descriptor for sort_order field.
	channelmonitorDescSortOrder := channelmonitorFields[10].Descriptor()
	// channelmonitor.DefaultSortOrder holds the default value on creation for the sort_order field.
	channelmonitor.DefaultSortOrder = channelmonitorDescSortOrder.Default.(int)
	...
	// channelmonitorDescProbeAttempts is the schema descriptor for probe_attempts field.
	channelmonitorDescProbeAttempts := channelmonitorFields[14].Descriptor()
	// channelmonitor.DefaultProbeAttempts holds the default value on creation for the probe_attempts field.
	channelmonitor.DefaultProbeAttempts = channelmonitorDescProbeAttempts.Default.(int)
	// channelmonitor.ProbeAttemptsValidator is a validator for the "probe_attempts" field. It is called by the builders before save.
	channelmonitor.ProbeAttemptsValidator = channelmonitorDescProbeAttempts.Validators[0].(func(int) error)
	...
	groupDescOpenaiAutoSchedulerEnabled := groupFields[55].Descriptor()
	...
	groupDescAllowAutoCheapestScheduling := groupFields[56].Descriptor()
	...
	groupDescUpstreamBalanceRefreshEnabled := groupFields[57].Descriptor()
	...
	groupDescUpstreamBalanceRefreshIntervalSeconds := groupFields[58].Descriptor()
	...
	groupDescUpstreamPriceMaxMultiplier := groupFields[59].Descriptor()
	...
	groupDescUpstreamPriceGroupingEnabled := groupFields[60].Descriptor()
	...
	groupDescUpstreamPriceGroupingMin := groupFields[61].Descriptor()
	...
	groupDescUpstreamPriceGroupingMax := groupFields[62].Descriptor()
	...
	usagelogDescGroupName := usagelogFields[14].Descriptor()
	...
	usagelogDescAPIKeyGroupSelectMode := usagelogFields[16].Descriptor()
	...
	usagelogDescChannelPriceSource := usagelogFields[33].Descriptor()
