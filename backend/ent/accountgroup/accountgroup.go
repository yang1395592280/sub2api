...
const (
	...
	// FieldPriceGroupingLocked holds the string denoting the price_grouping_locked field in the database.
	FieldPriceGroupingLocked = "price_grouping_locked"
...
var (
	...
	DefaultPriority int
	// DefaultPriceGroupingLocked holds the default value on creation for the "price_grouping_locked" field.
	DefaultPriceGroupingLocked bool
...
// ByPriceGroupingLocked orders the results by the price_grouping_locked field.
func ByPriceGroupingLocked(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldPriceGroupingLocked, opts...).ToFunc()
}
