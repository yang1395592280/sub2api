...
func (OpenAIAutoSchedulerScoreState) Fields() []ent.Field {
	return []ent.Field{
		...
		field.Int("final_score").Default(6000).Range(0, 10000),
		field.Int("base_score").Default(6000).Range(0, 10000),
		field.Int("latency_score").Default(0).Range(0, 10000),
		field.Int("error_score").Default(0).Range(0, 10000),
		field.Int("recovery_score").Default(0).Range(0, 10000),
		field.Int("cost_score").Default(0).Range(0, 10000),
