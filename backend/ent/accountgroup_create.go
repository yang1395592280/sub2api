...
func (_c *AccountGroupCreate) SetPriceGroupingLocked(v bool) *AccountGroupCreate {
	_c.mutation.SetPriceGroupingLocked(v)
	return _c
}

// SetNillablePriceGroupingLocked sets the "price_grouping_locked" field if the given value is not nil.
func (_c *AccountGroupCreate) SetNillablePriceGroupingLocked(v *bool) *AccountGroupCreate {
	if v != nil {
		_c.SetPriceGroupingLocked(*v)
	}
	return _c
}
...
func (_c *AccountGroupCreate) defaults() {
	...
	if _, ok := _c.mutation.PriceGroupingLocked(); !ok {
		v := accountgroup.DefaultPriceGroupingLocked
		_c.mutation.SetPriceGroupingLocked(v)
	}
...
func (_c *AccountGroupCreate) check() error {
	...
	if _, ok := _c.mutation.PriceGroupingLocked(); !ok {
		return &ValidationError{Name: "price_grouping_locked", err: errors.New(`ent: missing required field "AccountGroup.price_grouping_locked"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
...
func (_c *AccountGroupCreate) createSpec() (*AccountGroup, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.PriceGroupingLocked(); ok {
		_spec.SetField(accountgroup.FieldPriceGroupingLocked, field.TypeBool, value)
		_node.PriceGroupingLocked = value
	}
...
// SetPriceGroupingLocked sets the "price_grouping_locked" field.
func (u *AccountGroupUpsert) SetPriceGroupingLocked(v bool) *AccountGroupUpsert {
	u.Set(accountgroup.FieldPriceGroupingLocked, v)
	return u
}

// UpdatePriceGroupingLocked sets the "price_grouping_locked" field to the value that was provided on create.
func (u *AccountGroupUpsert) UpdatePriceGroupingLocked() *AccountGroupUpsert {
	u.SetExcluded(accountgroup.FieldPriceGroupingLocked)
	return u
}
...
// SetPriceGroupingLocked sets the "price_grouping_locked" field.
func (u *AccountGroupUpsertOne) SetPriceGroupingLocked(v bool) *AccountGroupUpsertOne {
	return u.Update(func(s *AccountGroupUpsert) {
		s.SetPriceGroupingLocked(v)
	})
}

// UpdatePriceGroupingLocked sets the "price_grouping_locked" field to the value that was provided on create.
func (u *AccountGroupUpsertOne) UpdatePriceGroupingLocked() *AccountGroupUpsertOne {
	return u.Update(func(s *AccountGroupUpsert) {
		s.UpdatePriceGroupingLocked()
	})
}
...
// SetPriceGroupingLocked sets the "price_grouping_locked" field.
func (u *AccountGroupUpsertBulk) SetPriceGroupingLocked(v bool) *AccountGroupUpsertBulk {
	return u.Update(func(s *AccountGroupUpsert) {
		s.SetPriceGroupingLocked(v)
	})
}
...
// UpdatePriceGroupingLocked sets the "price_grouping_locked" field to the value that was provided on create.
func (u *AccountGroupUpsertBulk) UpdatePriceGroupingLocked() *AccountGroupUpsertBulk {
	return u.Update(func(s *AccountGroupUpsert) {
		s.UpdatePriceGroupingLocked()
	})
}
