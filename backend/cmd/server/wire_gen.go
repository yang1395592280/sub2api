...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	openAIUpstreamBalanceService := service.ProvideOpenAIUpstreamBalanceService(accountRepository, cnProviderBalanceService)
