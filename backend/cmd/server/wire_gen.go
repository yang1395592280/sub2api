...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	affiliateTicketCampaignRepository := repository.NewAffiliateTicketCampaignRepository(db)
	affiliateTicketCampaignService := service.ProvideAffiliateTicketCampaignService(affiliateTicketCampaignRepository, settingService)
	affiliateService := service.ProvideAffiliateService(affiliateRepository, settingService, apiKeyAuthCacheInvalidator, billingCacheService, affiliateTicketCampaignService)
	...
	adminUserHandler := handler.ProvideAdminUserHandler(adminService, concurrencyService, serviceUserPlatformQuotaRepository, billingCache, totpService, userService, settingService, apiKeyRepository)
	...
	affiliateHandler := handler.ProvideAdminAffiliateHandler(affiliateService, adminService, affiliateTicketCampaignService)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, cnProviderHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, workbenchHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, openAIAutoSchedulerHandler, contentModerationHandler, promptAdminHandler, paymentHandler, affiliateHandler, complianceHandler, zenxiangLiyuHandler, auditLogHandler, upstreamBillingProbeService, ollamaCloudUsageService)
