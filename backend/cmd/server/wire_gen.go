...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	sizeBetHandler := handler.NewSizeBetHandler(sizeBetService)
	...
	userHandler := handler.NewUserHandler(userService, checkinService, emailService, turnstileService, emailCache, adminService)
	...
	windsurfAccountHandler := handler.NewWindsurfAccountHandler(windsurfAccountService)
	idempotencyCoordinator := service.ProvideIdempotencyCoordinator(idempotencyRepository, configConfig)
	idempotencyCleanupService := service.ProvideIdempotencyCleanupService(idempotencyRepository, configConfig)
	handlers := handler.ProvideHandlers(authHandler, userHandler, windsurfAccountHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, sizeBetHandler, sizeBetRuntimeService, idempotencyCoordinator, idempotencyCleanupService)
