...
const supportsUpstreamAdminSettings = computed(() =>
  form.type === 'apikey' &&
  (form.platform === 'openai' || form.platform === 'anthropic' || form.platform === 'gemini' || form.platform === 'kimi' || form.platform === 'deepseek' || form.platform === 'zhipu' || form.platform === 'grok')
)
...
const MAX_POOL_MODE_RETRY_COUNT = 30
