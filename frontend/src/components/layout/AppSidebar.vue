...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    ...(appStore.cachedPublicSettings?.redeem_code_purchase_enabled
      ? [{
          path: '/redeem-code-purchase',
          label: appStore.cachedPublicSettings.redeem_code_purchase_name || t('nav.redeemCodePurchase'),
          icon: TicketIcon,
          externalUrl: appStore.cachedPublicSettings.redeem_code_purchase_url,
  ...
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/groups', label: t('nav.groups'), icon: FolderIcon, hideInSimpleMode: true },
    {
      ...
      children: [
        ...
        { path: '/admin/openai-auto-scheduler', label: t('nav.openaiAutoScheduler'), icon: BoltIcon },
      ],
    },
    ...
    { path: '/admin/promo-codes', label: t('nav.promoCodes'), icon: GiftIcon, hideInSimpleMode: true },
    {
      ...
      children: [
        ...
        { path: '/admin/affiliates/ticket-campaign', label: t('nav.affiliateTicketCampaign'), icon: TicketIcon },
