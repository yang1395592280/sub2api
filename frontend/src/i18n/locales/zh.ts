export default {
  ...
  windsurfAccounts: {
    title: 'Windsurf 账号维护',
    description: '维护 Windsurf 账号与密码，记录最近维护人和维护时间，并由管理员控制是否启用。',
    ...
    maintainedAt: '维护时间',
    actions: '操作',
    noData: '暂无 Windsurf 账号',
    loadFailed: '加载 Windsurf 账号失败',
    createSuccess: 'Windsurf 账号已新增',
    updateSuccess: 'Windsurf 账号已更新',
    saveFailed: '保存 Windsurf 账号失败',
    statusUpdateSuccess: '账号状态已更新',
    statusUpdateFailed: '更新账号状态失败',
    passwordLoadFailed: '加载密码失败',
    passwordCopied: '密码已复制',
    accountCopied: '账号已复制',
    autoDisableHint: '用户每次维护账号或密码后，记录会自动回到未启用状态，等待管理员重新启用。',
    noticeTitle: '维护公告',
    noticeIntro: '请前往 Windsurf 官网注册账号：',
    noticeItems: {
      register: '注册完成后开通 Pro 订阅，标准价格 20 美元/月，新用户可享受免费订阅。',
      subscription: '建议关闭梯子，或者切换到香港节点后再操作支付。',
      payment: '出现支付宝绑定后完成支付，支付完成后一定要解绑；一个支付宝可以注册多个账号。',
      multiplier: '凡是提供账号者，Claude 按 0.5 倍率；其他用户按 2 倍率。'
    },
    reveal: '查看',
    hide: '隐藏',
    enable: '启用',
  ...
  sizeBet: {
    ...
    history: {
      title: '我的参与记录',
      subtitle: '查看最近参与记录与开奖结果',
      refreshFailed: '最新记录暂未同步，请稍后重试。',
      refreshRetry: '重试同步',
      toggleMore: '展开更多',
      toggleLess: '收起记录',
      empty: '暂无参与记录',
    ...
    statsPage: {
      title: '竞猜统计',
      description: '按日期查看竞猜整体参与情况和用户盈亏排行',
      subtitle: '这里展示后台统计中的公开数据，方便用户查看每日整体参与概览。',
      date: '统计日期',
      rank: '排名',
      emptyTitle: '暂无统计数据',
      emptyDescription: '当前日期还没有可展示的竞猜统计'
    },
    directions: {
      small: '小',
      mid: '中',
  ...
  profile: {
    ...
    checkin: {
      ...
      action: '立即签到',
      luckyBonusAction: '奖励翻倍',
      luckyBonusPending: '命运翻牌中...',
      luckyBonusDisabledHint: '签到后才可以试试手气',
      luckyBonusAlreadyPlayed: '今日命运已揭晓',
      luckyBonusSuccess: '运气真好，奖励翻倍',
      luckyBonusFailure: '运气真差，扣除奖励',
      luckyBonusResultWin: '运气真好，直接翻倍',
      luckyBonusResultLose: '手气不佳，被命运反噬',
      luckyBonusResultTitle: '今日命运签',
      luckyBonusResultBase: '原始奖励',
      luckyBonusResultFinal: '最终奖励',
      luckyBonusResultDelta: '本次变化',
      checkedToday: '今日已签到',
      submitting: '签到中...',
      ...
      ruleFour: '签到后可挑战一次“奖励翻倍”，成功翻倍，失败则变为原奖励的一半倒扣。',
      weekdays: {
        mon: '一',
        tue: '二',
        wed: '三',
  ...
  admin: {
    ...
    users: {
      ...
      totalRecharged: '总充值',
      balanceAfter: '余额结余',
      concurrencyAfter: '调整后并发',
      expandDetails: '展开明细',
      collapseDetails: '收起明细',
      gameRoundNo: '回合',
      gameStakeAmount: '参与扣减',
      gamePayoutAmount: '开奖结算',
      gameResult: '开奖结果',
      // Settings Dropdowns
      filterSettings: '筛选设置',
      columnSettings: '列设置',
    ...
    windsurfAccounts: {
      ...
      updateSuccess: 'Windsurf 账号已更新',
      deleteTitle: '删除账号',
      deleteConfirm: "确定要删除账号 '{account}' 吗？此操作无法撤销。",
      deleteSuccess: 'Windsurf 账号已删除',
      deleteFailed: '删除 Windsurf 账号失败',
      saveFailed: '保存 Windsurf 账号失败',
      statusUpdateSuccess: '账号状态已更新',
      statusUpdateFailed: '更新账号状态失败',
      passwordLoadFailed: '加载密码失败',
    ...
    settings: {
      ...
      checkin: {
        ...
        luckyBonusEnabled: '启用奖励翻倍玩法',
        luckyBonusSuccessRate: '翻倍成功概率',
        luckyBonusSuccessRateHint: '用户签到后可额外点击一次“奖励翻倍”。成功则变成 2 倍，失败则结算为 -0.5 倍。',
