export default {
  ...
  admin: {
    ...
    businessAnalytics: {
      title: '业务分析',
      description: '按分组、渠道和明细记录查看收入、成本与毛利表现。',
      platform: '平台',
      allPlatforms: '全部平台',
      granularity: '统计粒度',
      day: '按天',
      ...
      metrics: {
        ...
        activeUsers: '活跃用户',
        requests: '请求数',
        revenuePerActiveUser: '人均收入',
        profitPerActiveUser: '人均毛利'
      },
      columns: {
        date: '日期',
        time: '时间',
        ...
        grossProfit: '毛利',
        profitMargin: '毛利率',
        previousChange: '较前期变化',
        missingPrice: '缺价格记录',
        user: '用户',
        apiKey: 'API Key',
        channelAccount: '渠道账号',
        model: '模型',
        tokensRequests: 'Token / 请求',
        groupRateSnapshot: '分组倍率快照',
        channelPriceSnapshot: '渠道价格快照'
      },
      empty: {
        groups: '当前筛选条件下暂无分组数据',
        channels: '当前筛选条件下暂无渠道数据',
        records: '当前筛选条件下暂无明细记录'
      }
    },
    // Dashboard
    dashboard: {
