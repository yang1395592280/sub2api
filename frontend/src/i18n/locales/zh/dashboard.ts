export default {
  ...
  keys: {
    ...
    openaiAutoCheapest: {
      ...
      maxRatePlaceholder: '默认 0.2',
      maxRateHint: '仅选择真实倍率不高于该值的候选分组，未填写时按 0.2 处理。',
      maxRateCurrent: '最高倍率 {rate}x',
      maxRateUnlimited: '最高 0.2x',
    },
    allGroups: '全部分组',
    allStatus: '全部状态',
    columnSettings: '列设置',
  ...
  usage: {
    ...
    latencyE2EFirstToken: '端到端',
    latencyUpstreamFirstToken: '上游',
    latencyDuration: '总耗时',
    latencyBreakdown: '阶段耗时',
    latencyBodyRead: '请求体读取',
    latencyPreprocess: '前置处理',
    latencyUserQueue: '站内并发等待',
    latencyRouting: '账号路由',
    latencyAccountQueue: '账号队列',
    latencyRetry: '重试等待',
    latencyOtherPreForward: '其他转发前',
    time: '时间',
    ws: 'WS',
    stream: '流式',
    sync: '同步',
  ...
  affiliate: {
    ...
    ticketCampaign: {
      title: '邀请抽奖券活动',
      description: '满足参与条件后，邀请好友注册和完成首次充值均可获得额外抽奖机会。',
      statusEligible: '已解锁活动资格',
      statusPending: '暂未解锁',
      statusPaused: '活动暂未开放',
      pausedNotice: '活动目前处于暂停状态，已获得的抽奖券仍可在有效期内正常使用。',
      eligibilityTitle: '参与条件',
      eligibilityDescription: '为保障活动体验，本活动面向已有正常使用记录的活跃用户开放。以下资格由系统实时核验。',
      usageRecord: '已有正常使用记录',
      conditionMet: '已满足',
      conditionPending: '继续使用后即可满足',
      historicalUsageRule: '累计使用金额超过 {amount}',
      balanceRule: '当前账户余额高于 {amount}',
      currentValue: '当前 {amount}',
      inviteeBonusTitle: '好友新人礼',
      inviteeBonusDescription: '解锁活动资格后，通过您的邀请链接完成注册的新用户，可获赠 {amount} 体验额度。每位新用户仅可领取一次。',
      rewardProgress: '今日奖励进度',
  ...
  redeem: {
    ...
    lotteryTicketsAdded: '已发放 {count} 张臻享礼遇抽奖券',
    lotteryTicketRedeemed: '臻享礼遇抽奖券兑换',
    lotteryTicketCount: '{count} 张抽奖券',
    days: '天',
