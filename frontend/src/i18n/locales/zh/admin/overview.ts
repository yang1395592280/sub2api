export default {
    ...
    dashboard: {
      ...
      spendingRankingDescription: '按实际消费、请求数和 Token 统计用户排行',
      ...
      spendingRankingWindow: '{start} 至 {end}',
      rankUsers: '排行用户',
      viewAllRanking: '查看完整排行',
      openaiAutoCheapestUsers: '自动低价用户 {count}',
      openaiAutoCheapestUsersDialogTitle: 'OpenAI 自动低价用户',
      openaiAutoCheapestUsersDialogHint: '当前共有 {count} 个用户启用了 OpenAI 自动低价分组。',
      openaiAutoCheapestUsersEmpty: '暂无用户启用 OpenAI 自动低价分组。',
      openaiAutoCheapestMaxRate: '最高倍率',
      openaiAutoCheapestMaxRateUnlimited: '不限倍率',
      sortBy: '排序方式',
      sortAsc: '升序',
      sortDesc: '降序',
      exportRanking: '导出排行',
    ...
    users: {
      ...
      emailListSearchPlaceholder: '搜索邮箱，支持一行一个或逗号分隔',
      lastUsedAt: '最后使用',
      balanceSummary: {
        label: '用户余额汇总',
        failed: '加载用户余额汇总失败',
    ...
    groups: {
      ...
      form: {
        ...
        upstreamPriceMaxMultiplier: '上游价格保护倍率',
        ...
        dynamicBillingProfitMarkup: '分组固定利润',
        dynamicBillingProfitMarkupPlaceholder: '留空继承全局固定利润',
        dynamicBillingProfitMarkupHint: '留空继承系统设置；填写后覆盖全局值；填 0 表示本分组不加固定利润。',
        rpmLimit: '每分钟请求数 (RPM)',
        rpmLimitPlaceholder: '0 表示不限制',
      ...
      currentSortOrder: '当前排序：{order}',
      dragToSort: '拖拽调整排序',
      moveUp: '上移',
      moveDown: '下移',
      viewMembers: '查看成员',
      viewCapacityUsers: '查看容量用户',
      membersTitle: '分组成员：{name}',
      membersCount: '{count} 个成员',
      noMembers: '暂无成员',
      publicGroupNoFixedMembers: '公开分组没有固定成员，所有用户都可选择使用。',
      removeMember: '移除成员',
      removeMemberConfirm: '确定要从该分组移除用户「{email}」吗？',
      memberRemoved: '成员已移除',
      failedToRemoveMember: '移除成员失败',
      failedToLoadMembers: '加载分组成员失败',
      memberUsageToday: '今日用量',
      memberUsageYesterday: '昨日用量',
      memberUsageLoadFailed: '加载成员用量失败',
      capacityUsersTitle: '容量明细：{name}',
      capacityUsersActiveOnly: '仅显示有活跃容量的用户',
      noActiveCapacityUsers: '暂无活跃容量用户',
      groupRpmLimit: '分组 RPM',
      userRpmLimit: '用户 RPM',
      rpmOverride: '专属 RPM',
      validation: {
        upstreamBalanceRefreshIntervalMin: '上游余额自动刷新间隔不能小于 60 秒',
        upstreamPriceMaxMultiplierMin: '上游价格保护倍率不能小于 0',
        upstreamPriceGroupingRequiresRefresh: '按渠道价格自动归组需要先启用上游余额自动刷新',
        upstreamPriceGroupingPositive: '渠道价格区间上下限必须大于 0',
        upstreamPriceGroupingOrder: '渠道价格区间下限不能大于上限',
        dynamicBillingProfitMarkupNonNegative: '分组固定利润必须大于或等于 0，或留空继承全局配置',
      },
