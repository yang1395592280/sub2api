export default {
    ...
    openaiAutoScheduler: {
      ...
      settings: {
        runtime: '运行模式', globalScheduler: '全局调度', mode: '模式', shadowMode: '影子观察', firstOutput: '请求首字与换号', firstOutputTimeout: '普通请求首字超时 (秒)', highEffortFirstOutputTimeout: '高推理请求首字超时 (秒)', balancedSelection: '策略与流量分配', topK: '基础 Top-K', adaptiveTopK: '自适应 Top-K', explorationRate: 'Top-K 内探索率', explorationBudget: '低置信探索预算', explorationMinInterval: '最小探索间隔 (秒)', explorationMaxPerHour: '每维度每小时探索上限', staleOpenRequiresProbe: '过期熔断须先探测', sessionEscapeGap: '会话逃逸差值 (ms)', sessionEscapeRatio: '会话逃逸比例', costWeight: '兼容成本权重', temperature: '分配温度', maxAccountShare: '单账号最大份额', lowConfidenceShare: '低置信度最大份额', latencyBudget: '延迟预算 (ms)', policyWeights: '综合效用权重',
