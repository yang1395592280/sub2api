export default {
    accounts: {
      ...
      channelPrice: '渠道价格',
      channelPriceHint: '用于展示/排序该账号对应渠道的倍率价格，实际计费仍以分组和渠道配置为准。',
      ...
      upstreamGroupName: '上游分组名称',
      upstreamGroupNamePlaceholder: '请输入上游分组名称',
      upstreamGroupNameHint: '用于账号列表展示；自动识别到上游分组后会更新为最新名称。',
      ...
      dataImportWarning: '导入将创建新账号与代理；请确认已有数据不会冲突。',
      dataImportFile: '数据文件',
      dataImportGroupsHint: '所选分组将应用到本次导入的全部账号；不选择则不绑定分组。',
      ...
      schedulerHealth: {
        unified: '统一健康 {available}/{total}',
        stale: '过期 {count}',
        legacy: '旧评分 · {model}',
        states: { running: '正常', observing: '观察中', open: '熔断中', half_open: '半开探测' }
      },
      schedulerReliability: {
        hint: '根据 OpenAI 自动调度近 7 天的真实请求与探测事件汇总。样本过少会标记为数据不足；成功率、慢请求率和平均首包耗时共同决定建议，仅供长期留存判断参考。',
        successRate: '成功',
        ttfb: '首包',
        samples: '{count} 次样本',
        activeDays: '{count}/7 天活跃',
        window: '近 7 天',
        recommendations: {
          stable: '适合长期',
          observe: '建议观察',
      ...
      bulkActions: {
        ...
        refreshBalanceNoEligible: '所选账号中没有可刷新上游余额的 OpenAI 账号',
        refreshBalanceSuccess: '已成功刷新 {count} 个账号余额',
        refreshBalancePartial: '余额刷新部分完成：成功 {success} 个，失败 {failed} 个',
        probeUpstreamBilling: '探测上游倍率',
        resetStatusSuccess: '已成功重置 {count} 个账号状态',
        refreshTokenSuccess: '已成功刷新 {count} 个账号令牌',
        partialSuccess: '操作部分完成：{success} 成功，{failed} 失败'
      },
      bulkTestHint: '批量测试会按并发数逐个调用账号测试接口，并汇总成功、失败和错误分类。',
      bulkTestConcurrency: '测试并发数',
      bulkTestProgress: '测试进度：{current}/{total}',
      bulkTestSummary: '测试完成：成功 {success}，失败 {failed}',
      bulkOpenAIStatsTitle: 'OpenAI 账号统计',
      bulkOpenAIStatsProgress: '用量查询：{current}/{total}',
      bulkOpenAIStatsPlan: '套餐分布',
      bulkOpenAIStatsFree: 'Free',
      bulkOpenAIStatsPlus: 'Plus',
      bulkOpenAIStatsOther: '其他套餐',
      bulkOpenAIStatsUnknown: '未知',
      bulkOpenAIStatsSevenDayUsage: '7 天用量',
      bulkOpenAIStatsUsageLow: '≤ 5%',
      bulkOpenAIStatsUsageHigh: '> 5%',
      bulkOpenAIStatsUsageUnknown: '未知',
      bulkTestFailureBreakdownTitle: '失败分类',
      bulkTestFailureCategory: '{category}：{count} 个',
      bulkTestHasFailures: '存在测试失败的账号，请查看结果详情。',
      ...
      openai: {
        ...
        overbrush: '是否超刷',
        overbrushDesc: '开启后，该 OpenAI OAuth 账号遇到 429 会继续调度，连续达到全局阈值后才进入限流中。',
