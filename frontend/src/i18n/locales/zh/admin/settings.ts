export default {
    settings: {
      ...
      openAIOverbrush: {
        title: 'OpenAI 超刷设置',
        description: '配置开启“是否超刷”的 OpenAI OAuth 账号连续 429 后进入限流的全局阈值',
        consecutive429Threshold: '连续 429 阈值',
        consecutive429ThresholdHint: '1-100 次，默认 10 次。达到阈值后账号会按原逻辑进入限流中。',
      ...
      openaiFastPolicy: {
        ...
        scopeBedrock: '仅 Bedrock 账号',
        userIds: '限定用户 ID',
        userIdsHint: '可选。填写后仅对这些用户 ID 的请求生效。',
