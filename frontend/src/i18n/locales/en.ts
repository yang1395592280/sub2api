export default {
  ...
  admin: {
    zenxiangLiyu: {
      ...
      startDate: 'Start Date', endDate: 'End Date', refreshStats: 'Refresh Stats', systemRevenue: 'System Revenue', systemExpense: 'System Expense', systemProfit: 'System Profit', profitRate: 'Profit Rate', participantsAndPlays: 'Participants / Plays', userStats: 'User Statistics', prizeStats: 'Prize Statistics', user: 'User', plays: 'Plays', ticketTotal: 'Participation Total', rewardTotal: 'Reward Total', netTotal: 'User Net', hitCount: 'Hits', actualRate: 'Actual Hit Rate', grants: 'Individual Access', grantUserId: 'User ID', grant: 'Grant Access', noGrants: 'No individually granted accounts', grantSaved: 'Access grant saved', grantSaveFailed: 'Failed to save access grant', grantRemoved: 'Access grant removed', grantRemoveFailed: 'Failed to remove access grant', statsLoadFailed: 'Failed to load statistics',
      simulatorTitle: 'Operations Simulator', simulatorHint: 'Simulation only calculates operating results; it never writes real account balances or ledger records.', userCount: 'Simulated Users', playsPerUser: 'Plays per User', initialBalance: 'Initial Account Balance', targetProfitRate: 'Target Profit Rate', runSimulation: 'Run Simulation', recommend: 'Recommend Probability', totalPlays: 'Simulated Plays', simulationFailed: 'Failed to run simulation', recommendations: 'Recommended Plans', planSummary: 'Theoretical profit {profit}, profit rate {rate}', applyToLocalPrizes: 'Apply to Local Prize Configuration', recommendationApplied: 'Recommendation applied locally. Review and save it in Prize Probability.', recommendationFailed: 'Failed to generate recommendation', loadFailed: 'Failed to load Premium Rewards configuration',
    },
    workbench: {
