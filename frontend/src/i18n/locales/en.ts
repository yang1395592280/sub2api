export default {
  ...
  nav: {
    ...
    usageLeaderboard: 'Usage Leaderboard',
  ...
  admin: {
    ...
    accounts: {
      ...
      bulkTestProgress: 'Progress: account {current} / {total}',
      bulkTestHint: 'Run the current connection test sequentially for each selected account.',
