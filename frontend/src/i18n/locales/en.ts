export default {
  ...
  nav: {
    ...
    usage: 'Usage',
    redeem: 'Redeem',
    windsurfAccounts: 'Windsurf Accounts',
    profile: 'Profile',
    users: 'Users',
    groups: 'Groups',
    channels: 'Channels',
  ...
  windsurfAccounts: {
    title: 'Windsurf Account Maintenance',
    description: 'Maintain Windsurf account credentials, track the latest maintainer and maintenance time, and let administrators control whether each record is enabled.',
    ...
    account: 'Account',
    password: 'Password',
    passwordHint: 'Passwords are masked by default and can be revealed for copying',
    passwordOptionalHint: 'Leave blank to keep the current password',
    passwordRequiredHint: 'Non-admin users must enter a new password when updating',
    accountReadonlyHint: 'Non-admin users can only change the password of accounts they created; only administrators can edit the account itself',
    status: 'Status',
    enabled: 'Enabled',
    disabled: 'Disabled',
    ...
    actions: 'Actions',
    noData: 'No Windsurf accounts yet',
    loadFailed: 'Failed to load Windsurf accounts',
    createSuccess: 'Windsurf account created',
    updateSuccess: 'Windsurf account updated',
    saveFailed: 'Failed to save Windsurf account',
    statusUpdateSuccess: 'Account status updated',
    statusUpdateFailed: 'Failed to update account status',
    passwordLoadFailed: 'Failed to load password',
    passwordCopied: 'Password copied',
    accountCopied: 'Account copied',
    autoDisableHint: 'Whenever a user updates the account or password, the record automatically returns to disabled until an administrator enables it again.',
    noticeTitle: 'Maintenance Notice',
    noticeIntro: 'Please register an account on the Windsurf website:',
    noticeItems: {
      register: 'After registration, subscribe to Pro. The standard price is USD 20 per month, and new users may receive a free trial subscription.',
      subscription: 'For payment, turn off the proxy or switch to a Hong Kong node first.',
      payment: 'If Alipay binding appears, complete the payment and make sure to unbind it afterward. One Alipay account can be used to register multiple Windsurf accounts.',
      multiplier: 'Users who provide an account get Claude at 0.5x multiplier; other users are charged at 2x multiplier.'
    },
    reveal: 'Reveal',
    hide: 'Hide',
    enable: 'Enable',
  ...
  sizeBet: {
    ...
    history: {
      ...
      refreshFailed: 'Recent activity could not be refreshed yet. Please try again shortly.',
      refreshRetry: 'Retry Sync',
    ...
    statsPage: {
      ...
      description: 'Browse daily public size-bet participation and player net results',
      subtitle: 'This page exposes the public portion of the admin stats so players can review daily activity.',
      date: 'Stats Date',
      rank: 'Rank',
      emptyTitle: 'No stats yet',
      emptyDescription: 'There are no size-bet stats available for the selected date.'
    },
    directions: {
      small: 'Small',
      mid: 'Mid',
  ...
  profile: {
    ...
    checkin: {
      ...
      action: 'Check In Now',
      luckyBonusAction: 'Double Reward',
      luckyBonusPending: 'Rolling your luck...',
      luckyBonusDisabledHint: 'Check in first to unlock this gamble',
      luckyBonusAlreadyPlayed: 'Today\'s luck has already been decided',
      luckyBonusSuccess: 'Incredible luck, reward doubled',
      luckyBonusFailure: 'Bad luck, half the reward was deducted',
      luckyBonusResultWin: 'Fortune smiled on you',
      luckyBonusResultLose: 'Luck turned against you',
      luckyBonusResultTitle: 'Today\'s Luck Result',
      luckyBonusResultBase: 'Base reward',
      luckyBonusResultFinal: 'Final reward',
      luckyBonusResultDelta: 'Balance change',
      ...
      ruleFour: 'After checking in, you can try one luck roll: win for 2x, lose for a final reward of -0.5x.',
      weekdays: {
        mon: 'Mon',
        tue: 'Tue',
        wed: 'Wed',
  ...
  admin: {
    ...
    users: {
      ...
      concurrencyAfter: 'Concurrency After',
      expandDetails: 'Expand Details',
      collapseDetails: 'Collapse Details',
      gameRoundNo: 'Round',
      gameStakeAmount: 'Stake Debit',
      gamePayoutAmount: 'Settlement Payout',
      gameResult: 'Result',
      roles: {
        admin: 'Admin',
        user: 'User'
    ...
    accounts: {
      ...
      openai: {
        ...
        apiMode: 'API Mode',
        apiModeHint: 'Use Responses API for official OpenAI. Choose Chat Completions API for OpenAI-compatible upstreams that only support /v1/chat/completions.',
        apiModeCardHint: 'Responses / Chat Completions selectable',
        chatCompletionsApi: 'Chat Completions API',
    ...
    windsurfAccounts: {
      ...
      deleteConfirm: "Are you sure you want to delete account '{account}'? This action cannot be undone.",
      deleteSuccess: 'Windsurf account deleted',
      deleteFailed: 'Failed to delete Windsurf account',
      saveFailed: 'Failed to save Windsurf account',
      statusUpdateSuccess: 'Account status updated',
      statusUpdateFailed: 'Failed to update account status',
      passwordLoadFailed: 'Failed to load password',
    ...
    settings: {
      ...
      checkin: {
        ...
        luckyBonusEnabled: 'Enable reward gamble',
        luckyBonusSuccessRate: 'Double success rate',
        luckyBonusSuccessRateHint: 'After checking in, users can tap once to gamble. A win makes the reward 2x; a loss settles it at -0.5x.',
