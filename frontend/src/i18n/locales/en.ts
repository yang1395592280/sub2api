export default {
  ...
  workbench: {
    title: 'Workbench',
    description: 'Run chat and image workflows from the browser',
    conversations: 'Conversations',
    conversationsHint: 'Organize web workbench requests as reusable sessions.',
    newConversation: 'New Conversation',
    untitled: 'Untitled Conversation',
    emptyConversation: 'No messages yet. Send one to get started.',
    messagesCount: 'messages',
    emptyState: 'No conversations yet. Create one to start using the workbench.',
    workspaceHint: 'Chat and image requests are routed through the unified workbench backend.',
    settings: 'Settings',
    settingsHint: 'Choose an API key, model, and image generation options.',
    apiKey: 'API Key',
    selectApiKey: 'Select an active API key',
    model: 'Model',
    selectModel: 'Select a model',
    endpoint: 'Workbench Endpoint',
    modeChat: 'Chat',
    modeImage: 'Image',
    chatPlaceholder: 'Type a message. Press Enter to send and Shift+Enter for a new line.',
    ...
    you: 'You',
    assistant: 'Assistant',
    imageWorkflow: 'Image Mode',
    imageWorkflowGenerate: 'Generate',
    imageWorkflowEdit: 'Image to Image',
    referenceImage: 'Reference Image',
    referenceImageHint: 'Upload up to 4 reference images. Sending uses images_edits.',
    referenceImageRequired: 'Upload at least one reference image first',
    ...
    chatPanelBody: 'The selected API key and model are sent through the workbench API instead of calling upstream model endpoints directly.',
    routeOnlyHint: 'This page only communicates with backend workbench routes under `/workbench/...`.',
    apiKeyRequired: 'Please select an active API key',
  ...
  zenxiangLiyu: {
    ...
    description: 'Use your account balance to join the exclusive rewards activity',
    currentBalance: 'Account balance',
    ticketAmount: 'Participation amount',
    remainingPlays: 'Plays remaining today',
    configuredRewards: 'Available reward tiers',
    noRewards: 'No reward tiers are currently available',
    balanceUnit: 'CNY',
    open: 'Open rewards',
    opening: 'Opening',
    refresh: 'Refresh status',
    loading: 'Loading activity status',
    insufficientBalance: 'Your balance must be greater than {amount} CNY to participate',
    dailyLimitReached: 'Today\'s reward attempts have been used',
    maintenance: 'The activity is under maintenance',
    unavailable: 'Participation is currently unavailable',
    playHint: 'Each attempt uses {amount} CNY from your account balance',
    rewardResult: 'You received {amount} CNY in reward balance',
    rewardAmount: 'Reward balance: {amount} CNY',
  ...
  keys: {
    ...
    openaiAutoCheapest: {
      ...
      maxRatePlaceholder: 'Leave empty for unlimited',
      maxRateHint: 'Auto selection only uses OpenAI groups at or below this rate. User-specific rates are checked first.',
      maxRateCurrent: 'Max rate: ≤ {rate}',
      maxRateUnlimited: 'Max rate: unlimited'
    },
    statusLabel: 'Status',
  ...
  admin: {
    zenxiangLiyu: {
      ...
      refresh: 'Refresh', settings: 'Activity Settings', prizes: 'Prize Probability', stats: 'Access & Stats', simulator: 'Simulator',
      settingsTitle: 'Activity Settings', settingsHint: 'When enabled globally, all eligible users may participate. When disabled, only individually granted accounts may participate.',
      ticketAmount: 'Participation Amount', minimumBalance: 'Minimum Account Balance', dailyPlayLimit: 'Daily Play Limit', saveSettings: 'Save Settings', settingsSaved: 'Settings saved', settingsSaveFailed: 'Failed to save settings',
      prizeTitle: 'Prize Tiers and Probability', prizeHint: 'The backend calculates reward outcomes. Enabled prize probabilities must total 100%.', addPrize: 'Add Tier', newPrize: 'New Reward Tier', prizeName: 'Tier Name', rewardAmount: 'Reward Balance', probability: 'Probability', enabled: 'Enabled', sortOrder: 'Sort Order', remove: 'Remove', savePrizeConfiguration: 'Save Full Configuration', probabilityTotal: 'Enabled Probability Total', probabilityWarning: 'Enabled prize probabilities total {total}%. The full configuration can only be saved at 100%.', theoreticalExpense: 'Theoretical Expense / Play', theoreticalProfit: 'Theoretical Profit / Play', theoreticalProfitRate: 'Theoretical Profit Rate', prizesSaved: 'Prize configuration saved', prizesSaveFailed: 'Failed to save prize configuration',
      startDate: 'Start Date', endDate: 'End Date', refreshStats: 'Refresh Stats', statsRangeHint: 'Current stats APIs show all-time data. Date filtering can be connected here after backend support lands.', systemRevenue: 'System Revenue', systemExpense: 'System Expense', systemProfit: 'System Profit', profitRate: 'Profit Rate', participantsAndPlays: 'Participants / Plays', userStats: 'User Statistics', prizeStats: 'Prize Statistics', user: 'User', plays: 'Plays', ticketTotal: 'Participation Total', rewardTotal: 'Reward Total', netTotal: 'User Net', hitCount: 'Hits', configuredProbability: 'Configured Probability', actualRate: 'Actual Hit Rate', probabilityDiff: 'Diff', grants: 'Individual Access', grantSearchPlaceholder: 'Search normal users by ID or email', grantUserId: 'User ID', grant: 'Grant Access', noGrants: 'No individually granted accounts', grantSaved: 'Access grant saved', grantSaveFailed: 'Failed to save access grant', grantRemoved: 'Access grant removed', grantRemoveFailed: 'Failed to remove access grant', userSearchFailed: 'Failed to search users', statsLoadFailed: 'Failed to load statistics',
      simulatorTitle: 'Operations Simulator', simulatorHint: 'Simulation only calculates operating results; it never writes real account balances or ledger records.', simulationPrizeConfig: 'Simulation Prize Configuration', userCount: 'Simulated Users', playsPerUser: 'Plays per User', initialBalance: 'Initial Account Balance', targetProfitRate: 'Target Profit Rate', runSimulation: 'Run Simulation', recommend: 'Recommend Probability', totalPlays: 'Simulated Plays', simulationFailed: 'Failed to run simulation', recommendations: 'Recommended Plans', planSummary: 'Theoretical profit {profit}, profit rate {rate}', applyRecommendation: 'Apply as Formal Prize Configuration', applyToLocalPrizes: 'Apply to Local Prize Configuration', recommendationApplied: 'Recommendation applied as the formal prize configuration.', recommendationFailed: 'Failed to generate recommendation', loadFailed: 'Failed to load Premium Rewards configuration',
    },
    workbench: {
    ...
    dashboard: {
      ...
      openaiAutoCheapestUsersDialogTitle: 'OpenAI Auto Cheapest Users',
      openaiAutoCheapestUsersDialogHint: '{count} users currently selected OpenAI auto-select cheapest group.',
      openaiAutoCheapestUsersEmpty: 'No users have selected auto cheapest group',
      openaiAutoCheapestMaxRate: 'Max Rate',
      openaiAutoCheapestMaxRateUnlimited: 'Unlimited',
      accounts: 'Accounts',
      users: 'Users',
      todayRequests: 'Today Requests',
    ...
    groups: {
      ...
      currentSortOrder: 'Current sort value',
      moveUp: 'Move up',
      moveDown: 'Move down',
      ...
      columns: {
        ...
        userNotes: 'Notes',
        user: 'User',
        currentConcurrency: 'Current Threads',
        currentRPM: 'Current RPM',
        rpmSource: 'RPM Source',
        rpmLimits: 'RPM Limits',
        userStatus: 'Status'
      },
      capacityUsersTitle: '{name} - Capacity Users',
      capacityUsersActiveOnly: 'Only users with current threads or RPM',
      noActiveCapacityUsers: 'No active users are currently consuming capacity',
      viewCapacityUsers: 'View capacity user details',
      groupRpmLimit: 'Group RPM',
      userRpmLimit: 'User RPM',
      rpmOverride: 'User Override RPM',
      rpmLimitSources: {
      ...
      viewMembers: 'Members',
      membersTitle: 'Group Members - {name}',
      membersCount: '{count} users',
      noMembers: 'No users currently belong to this group',
      publicGroupNoFixedMembers: 'This is a public standard group. All users can access it, so there is no fixed member list.',
      memberUsageToday: 'Today',
      memberUsageYesterday: 'Yesterday',
      memberUsageLoadFailed: 'Failed to load usage',
      memberUsageNoData: 'No usage',
      failedToLoadMembers: 'Failed to load group members',
      removeMember: 'Remove',
      removeMemberConfirm: 'Remove this user from the exclusive group and unbind their API keys in this group?',
      memberRemoved: 'User removed from group',
      failedToRemoveMember: 'Failed to remove user from group',
    ...
    accounts: {
      ...
      openai: {
        ...
        overbrush: 'Overbrush',
        overbrushDesc: 'When enabled, this OpenAI API Key account keeps scheduling after 429 responses until the global consecutive failure threshold is reached.',
      ...
      channelPrice: 'Channel Price',
      channelPriceHint: 'Real upstream price; lower price is preferred when tier and speed are close',
      channelPriceInvalid: 'Channel price must be greater than 0',
      expiresAt: 'Expires At',
      ...
      testLinkLabel: 'Test link',
      testResultRunning: 'Running',
      testResultSuccess: 'Passed',
      testResultFailed: 'Failed',
      selectTestModel: 'Select Test Model',
      bulkTestSummaryTitle: 'Batch Test Results',
      bulkTestProgress: 'Progress: {current} / {total} accounts completed',
      bulkTestHint: 'Run selected account tests with a controlled concurrency limit.',
    ...
    settings: {
      ...
      site: {
        ...
        joinGroup: {
          enabled: 'Enable Join Group Entry',
          enabledHint: 'When disabled, the "Join Group" button will be hidden on the home page and top navigation.',
          url: 'Group Link',
          urlPlaceholder: 'https://qm.qq.com/q/...',
          urlHint: 'Only http/https links are supported. If enabled but left empty, the button will still stay hidden on the frontend.',
          image: 'Popup Image',
          imagePlaceholder: 'Upload a group QR code or intro image',
          imageHint: 'When configured, clicking "Join Group" opens the image preview first. If a group link is also set, users can still continue to the link from the dialog.'
        },
        siteLogo: 'Site Logo',
