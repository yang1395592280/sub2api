export default {
    accounts: {
      ...
      channelPriceHint: 'Used to display/sort the account channel multiplier price. Billing still follows group and channel configuration.',
      channelPriceInvalid: 'Channel price must be greater than 0',
      upstreamGroupName: 'Upstream Group Name',
      upstreamGroupNamePlaceholder: 'Enter the upstream group name',
      upstreamGroupNameHint: 'Shown in the account list. A successful upstream refresh replaces it with the latest detected name.',
      ...
      dataImportWarning: 'Import will create new accounts/proxies. Ensure existing data does not conflict.',
      dataImportFile: 'Data file',
      dataImportGroupsHint: 'Selected groups apply to every account in this import. Leave empty to keep accounts ungrouped.',
      ...
      schedulerHealth: {
        unified: 'Unified health {available}/{total}',
        stale: 'Stale {count}',
      ...
      bulkActions: {
        ...
        refreshBalanceNoEligible: 'No selected OpenAI account supports upstream balance refresh',
        refreshBalanceSuccess: 'Refreshed balance for {count} account(s)',
        refreshBalancePartial: 'Balance refresh partially completed: {success} succeeded, {failed} failed',
        probeUpstreamBilling: 'Probe Upstream Rate',
        resetStatusSuccess: 'Successfully reset {count} account(s) status',
        refreshTokenSuccess: 'Successfully refreshed {count} account(s) token',
        partialSuccess: 'Partially completed: {success} succeeded, {failed} failed'
      },
      bulkTestHint: 'Batch testing calls the account test endpoint with the selected concurrency and summarizes successes, failures, and error categories.',
      bulkTestConcurrency: 'Test concurrency',
      bulkTestProgress: 'Progress: {current}/{total}',
      bulkTestSummary: 'Completed: {success} succeeded, {failed} failed',
      bulkOpenAIStatsTitle: 'OpenAI account statistics',
      bulkOpenAIStatsProgress: 'Usage queries: {current}/{total}',
      bulkOpenAIStatsPlan: 'Plan distribution',
      bulkOpenAIStatsFree: 'Free',
      bulkOpenAIStatsPlus: 'Plus',
      bulkOpenAIStatsOther: 'Other plans',
      bulkOpenAIStatsUnknown: 'Unknown',
      bulkOpenAIStatsSevenDayUsage: '7-day usage',
      bulkOpenAIStatsUsageLow: '<= 5%',
      bulkOpenAIStatsUsageHigh: '> 5%',
      bulkOpenAIStatsUsageUnknown: 'Unknown',
      bulkOpenAIStatsFilterActive: 'Current filter: {label} ({count} accounts)',
      bulkOpenAIStatsClearFilter: 'Clear filter',
      bulkOpenAIStatsNoMatches: 'No accounts to display in this category',
      bulkTestFailureBreakdownTitle: 'Failure breakdown',
      bulkTestFailureCategory: '{category}: {count}',
      bulkTestHasFailures: 'Some accounts failed testing. Review the details.',
      bulkDownloadSuccessEmails: 'Download success emails',
      bulkDownloadFailedEmails: 'Download failed emails',
      testLinkLabel: 'Test endpoint',
      ...
      openai: {
        ...
        overbrush: 'Overbrush',
        overbrushDesc: 'When enabled, this OpenAI OAuth account keeps scheduling after 429 responses until the global consecutive failure threshold is reached.',
