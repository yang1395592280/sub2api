export default {
    ...
    channelMonitor: {
      ...
      sortOrder: 'Sort',
      sortOrderHint: 'Drag monitors to adjust display order. Monitors near the top are shown first.',
      sortOrderUpdated: 'Sort order updated',
      sortOrderFailed: 'Failed to update sort order',
      dragToSort: 'Drag to reorder',
      currentSortOrder: 'Current order',
      moveUp: 'Move up',
      moveDown: 'Move down',
      ...
      form: {
        ...
        probeAttemptsHint: 'Run this many probes per model concurrently. Prefer the healthiest result, then the lowest latency (1-5).',
