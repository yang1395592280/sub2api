export default {
    ...
    openaiAutoScheduler: {
      ...
      settings: {
        runtime: 'Runtime mode', globalScheduler: 'Global scheduler', mode: 'Mode', shadowMode: 'Shadow mode', balancedSelection: 'Policy and traffic allocation', topK: 'Base Top-K', adaptiveTopK: 'Adaptive Top-K', explorationRate: 'Within Top-K exploration', explorationBudget: 'Low-confidence budget', explorationMinInterval: 'Minimum exploration interval (seconds)', explorationMaxPerHour: 'Explorations per dimension per hour', staleOpenRequiresProbe: 'Probe stale circuits first', sessionEscapeGap: 'Session escape gap (ms)', sessionEscapeRatio: 'Session escape ratio', costWeight: 'Legacy cost weight', temperature: 'Allocation temperature', maxAccountShare: 'Maximum account share', lowConfidenceShare: 'Low-confidence maximum share', latencyBudget: 'Latency budget (ms)', policyWeights: 'Utility weights',
