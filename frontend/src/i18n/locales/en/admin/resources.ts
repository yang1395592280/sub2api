export default {
    ...
    openaiAutoScheduler: {
      ...
      refresh: 'Refresh',
      modes: { legacy: 'Legacy mode', balanced: 'Balanced mode', shadow: 'Shadow', live: 'Live' },
      tabs: { overview: 'Overview', health: 'Account health', events: 'Events', settings: 'Rollout & settings' },
      ...
      settings: {
        runtime: 'Runtime mode', globalScheduler: 'Global scheduler', mode: 'Mode', shadowMode: 'Shadow mode', balancedSelection: 'Balanced selection', topK: 'Top-K', explorationRate: 'Exploration rate', sessionEscapeGap: 'Session escape gap (ms)', sessionEscapeRatio: 'Session escape ratio', costWeight: 'Cost weight',
        ...
        errors: { probeModelRequired: 'Probe model is required', topKRange: 'Top-K must be between 1 and 10', explorationRange: 'Exploration rate must be between 0 and 0.1', sessionGapRange: 'Session escape gap must be between 0 and 30000 ms', sessionRatioRange: 'Session escape ratio must be between 0 and 2', costWeightRange: 'Cost weight must be between 0 and 1', positiveRequired: 'Probe, circuit breaker, and recovery values must be greater than 0', severeThreshold: 'Severe threshold cannot be lower than slow threshold', jitterRange: 'Probe jitter cannot exceed half the probe interval', healthTTLRange: 'Health TTL must be between 60 and 86400 seconds', realFreshnessRange: 'Real sample freshness must be between 30 and 3600 seconds' }
      },
