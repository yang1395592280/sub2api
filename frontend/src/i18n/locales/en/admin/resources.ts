export default {
    ...
    zenxiangLiyu: {
      ...
      luckyCoinHint: 'After winning, users can flip once. A miss results in a net loss equal to the original reward.',
      luckyCoinDoubleProbability: 'Double Chance (%)',
      guessSizeEnabled: 'High or Low Game',
      guessSizeHint: 'After a lucky hit: win for 4x or miss for -4x. After a miss: win to recover to zero.',
      guessBigProbability: 'High Probability (%)',
      guessSmallProbability: 'Low Probability (%)',
      guessProbabilityTotal: 'Probability Total',
      ...
      userRecordGuessResult: 'High or Low',
      userRecordGuessAdjustment: 'Game Adjustment',
      ...
      userRecordGuessNotPlayed: 'Not played',
      userRecordGuessSkipped: 'Skipped',
      userRecordGuessWon: 'Won',
      userRecordGuessMissed: 'Missed',
    ...
    redeem: {
      ...
      amount: 'Amount ($)',
      value: 'Value',
      ticketCountValue: '{count} ticket(s)',
      count: 'Count',
      ...
      types: {
        ...
        concurrency: 'Concurrency',
        subscription: 'Subscription',
        lottery_ticket: 'Lottery Tickets',
        invitation: 'Invitation',
