export default {
    ...
    openaiAutoScheduler: {
      ...
      ranking: {
        ...
        candidates: 'Candidates', eligible: 'Eligible', lowConfidence: 'Low confidence', rejected: 'Rejected', requests: 'Window requests', allEligibility: 'All eligibility', rank: 'Rank', qualification: 'Eligibility', utility: 'Utility', share: 'Target / actual share', target: 'target', actual: 'actual', performance: 'Performance', stability: 'Stability', cost: 'Cost', decision: 'Decision', noData: 'No rankable accounts in this group', drawerLabel: 'Account ranking detail', scoreBreakdown: 'Utility breakdown', runtimeFacts: 'Runtime facts', confidence: 'Confidence', noDeviation: 'Share is within expectation',
