export default {
    settings: {
      ...
      openAIOverbrush: {
        title: 'OpenAI Overbrush Settings',
        description: 'Configure the global consecutive-429 threshold for OpenAI OAuth accounts with overbrush enabled',
        consecutive429Threshold: 'Consecutive 429 Threshold',
        consecutive429ThresholdHint: '1-100 times, default 10. Once reached, the account follows the original rate-limit behavior.',
      ...
      openaiFastPolicy: {
        ...
        scopeAPIKey: 'API Key only',
        scopeBedrock: 'Bedrock only',
        userIds: 'Limit user IDs',
        userIdsHint: 'Optional. When set, this rule only applies to requests from these user IDs.',
