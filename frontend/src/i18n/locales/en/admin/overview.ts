export default {
    ...
    dashboard: {
      ...
      spendingRankingDescription: 'Rank users by actual spend, requests, and token usage',
      ...
      spendingRankingWindow: '{start} to {end}',
      rankUsers: 'Rank users',
      ...
      openaiAutoCheapestUsersDialogHint: '{count} user(s) currently have OpenAI auto cheapest group enabled.',
      openaiAutoCheapestUsersEmpty: 'No users have enabled OpenAI auto cheapest group.',
    ...
    users: {
      ...
      emailListSearchPlaceholder: 'Search emails, one per line or comma separated',
      lastUsedAt: 'Last used',
      balanceSummary: {
        label: 'User balance summary',
      ...
      bulkDelete: {
        ...
        confirmMessage: 'Delete the selected {count} user(s)? This action cannot be undone.',
        success: 'Deleted {count} user(s)',
        failed: 'Bulk delete users failed',
      },
      bulkAddGroup: {
        title: 'Bulk add group access',
        selectedUsers: '{count} user(s) selected',
        groupLabel: 'Group',
        groupPlaceholder: 'Select a group',
        groupRequired: 'Please select a group',
        confirm: 'Add group',
        success: 'Added "{group}" group access to {count} user(s)',
        failed: 'Bulk add group failed',
      },
      creating: 'Creating...',
      updating: 'Updating...',
      form: {
    ...
    groups: {
      ...
      form: {
        ...
        upstreamPriceMaxMultiplier: 'Upstream price guard multiplier',
        ...
        dynamicBillingProfitMarkup: 'Group fixed profit',
        dynamicBillingProfitMarkupPlaceholder: 'Leave blank to inherit the global fixed profit',
        dynamicBillingProfitMarkupHint: 'Leave blank to inherit the system setting; a value overrides the global setting; 0 disables fixed profit for this group.',
        rpmLimit: 'Requests Per Minute (RPM)',
        rpmLimitPlaceholder: '0 = unlimited',
      ...
      currentSortOrder: 'Current order: {order}',
      dragToSort: 'Drag to sort',
      moveUp: 'Move up',
      moveDown: 'Move down',
      viewMembers: 'View members',
      viewCapacityUsers: 'View capacity users',
      membersTitle: 'Group members: {name}',
      membersCount: '{count} member(s)',
      noMembers: 'No members',
      publicGroupNoFixedMembers: 'Public groups do not have fixed members. All users can choose them.',
      removeMember: 'Remove member',
      removeMemberConfirm: 'Remove user "{email}" from this group?',
      memberRemoved: 'Member removed',
      failedToRemoveMember: 'Failed to remove member',
      failedToLoadMembers: 'Failed to load group members',
      memberUsageToday: 'Today usage',
      memberUsageYesterday: 'Yesterday usage',
      memberUsageLoadFailed: 'Failed to load member usage',
      capacityUsersTitle: 'Capacity details: {name}',
      capacityUsersActiveOnly: 'Only show users with active capacity',
      noActiveCapacityUsers: 'No active capacity users',
      groupRpmLimit: 'Group RPM',
      userRpmLimit: 'User RPM',
      rpmOverride: 'RPM override',
      validation: {
        upstreamBalanceRefreshIntervalMin: 'Upstream balance auto refresh interval must be at least 60 seconds',
        upstreamPriceMaxMultiplierMin: 'Upstream price guard multiplier cannot be less than 0',
        upstreamPriceGroupingRequiresRefresh: 'Channel price grouping requires upstream balance auto refresh',
        upstreamPriceGroupingPositive: 'Channel price range bounds must be greater than 0',
        upstreamPriceGroupingOrder: 'Channel price range minimum cannot exceed maximum',
        dynamicBillingProfitMarkupNonNegative: 'Group fixed profit must be zero or greater, or left blank to inherit the global setting',
      },
