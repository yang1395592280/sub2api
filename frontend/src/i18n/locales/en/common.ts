export default {
  ...
  nav: {
    ...
    affiliateTicketCampaign: 'Invite Ticket Campaign',
  ...
  zenxiangLiyu: {
    ...
    affiliateTicketHint: 'Includes {count} invite campaign tickets (tracked separately)',
    affiliateTicketEmpty: 'Invite campaign tickets: 0 (tracked separately)',
    ...
    guessSizeWinPrompt: 'Your reward is doubled. Win to reach 4x; miss and the result becomes -4x. Take the challenge?',
    guessSizeLosePrompt: 'Your result is now the negative base reward. Win to recover to zero; miss to keep the current result. Take the challenge?',
    ...
    guessSizeRewardMiss: 'It was {outcome}. You missed, so the final reward is now -4x.',
    guessSizeMiss: 'It was {outcome}. You missed, so the current negative reward remains.',
    guessSizeRevealing: 'Fate is turning',
    guessSizeYourChoice: 'Your choice: {choice}',
    guessSizeOpened: 'Result: {outcome}',
