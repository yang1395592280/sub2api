export default {
  ...
  keys: {
    ...
    openaiAutoCheapest: {
      ...
      maxRatePlaceholder: 'Default 0.2',
      maxRateHint: 'Only choose candidate groups whose real rate is not above this value. Empty values default to 0.2.',
      maxRateCurrent: 'Max rate {rate}x',
      maxRateUnlimited: 'Maximum 0.2x',
    },
  ...
  usage: {
    ...
    latencyE2EFirstToken: 'End-to-end',
    latencyUpstreamFirstToken: 'Upstream',
    latencyDuration: 'Total',
    latencyBreakdown: 'Latency breakdown',
    latencyBodyRead: 'Request body',
    latencyPreprocess: 'Preprocessing',
    latencyUserQueue: 'Local concurrency wait',
    latencyRouting: 'Routing',
    latencyAccountQueue: 'Account queue',
    latencyRetry: 'Retry wait',
    latencyOtherPreForward: 'Other pre-forward',
    time: 'Time',
    ws: 'WS',
    stream: 'Stream',
    sync: 'Sync',
  ...
  affiliate: {
    ...
    ticketCampaign: {
      ...
      description: 'Once eligible, earn extra lottery chances when friends register and complete their first recharge.',
      statusEligible: 'Campaign unlocked',
      statusPending: 'Not unlocked yet',
      statusPaused: 'Campaign paused',
      pausedNotice: 'The campaign is currently paused. Tickets already issued remain usable until they expire.',
      eligibilityTitle: 'Participation eligibility',
      eligibilityDescription: 'To support a fair experience, this campaign is available to active users with established usage. Eligibility is verified by the server in real time.',
      usageRecord: 'Has normal usage history',
      conditionMet: 'Completed',
      conditionPending: 'Continue using the service to qualify',
      historicalUsageRule: 'Historical usage above {amount}',
      balanceRule: 'Current balance above {amount}',
      currentValue: 'Current: {amount}',
      inviteeBonusTitle: 'New friend welcome credit',
      inviteeBonusDescription: 'After you unlock the campaign, new users who register through your invite link receive {amount} in trial credit, once per new user.',
      rewardProgress: 'Today\'s reward progress',
  ...
  redeem: {
    ...
    lotteryTicketsAdded: 'Added {count} Zenxiang Liyu lottery ticket(s)',
    lotteryTicketRedeemed: 'Zenxiang Liyu Lottery Tickets',
    lotteryTicketCount: '{count} ticket(s)',
    days: ' days',
