...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/yang1395592280/sub2api/main/deploy/install.sh | bash
#
...
Documentation=https://github.com/yang1395592280/sub2api
